        ...
        <div className="rounded-2xl p-[1px] bg-gradient-to-b from-white/20 to-white/5">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <a href="/forgot-password" className="text-xs text-gray-400 hover:text-white">Forgot password?</a>
                </div>
                <input
                  type="password"
                  value={password}
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-black/70 py-4 text-gray-400">Or continue with</span>
            </div>
          </div>
